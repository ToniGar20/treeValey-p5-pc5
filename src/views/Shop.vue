          ...
          <div class="card col-4 " v-for="producto in productos" :key="producto">
            <div class="card-body">
              ...
              <div class="">
                ...
                <div class="my-3">
                <button class="btn btn-info position-absolute bottom-0 mb-3" @click="addToCart(producto)">Añadir</button>
        ...
        <div class="col-4">
          <div class="shop" v-if="showCart">
            ...
            <div class="d-flex justify-content-center mt-2">
              <router-link to="/checkout"><button class="btn btn-info btn-lg btn-block">Realizar pedido</button></router-link>
            </div>
          </div>
